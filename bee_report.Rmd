...
### Forudsigelse af træk
 Træk er når bierne henter nektar fra blomsterne, dvs. om vægten stiger. Hvis vægten ikke stiger, så den plejer at falde stille og rolig, fordi bierne begynder at spise det, som blev hentet. Så i denne sektion vil jeg prøve at finde ud af om bierne trækker ved at benytte vejrdata og sige om der er noget sammenhæng. Desunden biene trækker kun, når der er nektar dvs. om sommeren, så der blev valgt at analysere bierne kun i Juni måned, hvor der sker noget træk overhovedet. 


Resultat: vægten skal op eller ned. Dvs. vægt delta bliver mere end 0 eller mindre end 0
- Der blev valgt kun undersøge binernes trak kun i Juni måned, fordi det er der, hvor biene trakker be
...
Actual DOWN UP
  ...
  UP      3 17
```
- Man kan bruge disse finding til at give Early Warning til biavlen. Dvs når vi forudsiger at vægten skulle gå UP, men det gik faktisk DOWN, så det kan betyde at der er problem med familien. 
