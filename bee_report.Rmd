...
#### Backtesting 
Jeg fik også lavet en backtesting, fordi vi kender jo de empiriske værdier for marts måned, så disse også blev plottet  på grafen, og man må sige at modellen blev opsat ret korrekt, da alle empiriske værdier ligger ind i 95% konfidensinterval interval. 
